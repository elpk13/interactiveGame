...
#    WIN.blit(WOLF_GREY_IMAGE, (450,250))
    pygame.draw.rect(WIN,FORESTGN,[QUARTWID-50,HALFHEIGH,100,50])
    pygame.draw.rect(WIN,FORESTGN,[QUARTWID*2-50,HALFHEIGH,100,50])
    pygame.draw.rect(WIN,FORESTGN,[QUARTWID*3-50,HALFHEIGH,100,50])
